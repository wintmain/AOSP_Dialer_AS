...
package com.wintmain.dialer.about;
...
public final class Licenses {
    ...
    public static ArrayList<License> getLicenses(Context context) {
        return getLicenseListFromMetadata(
                getTextFromResource(context.getApplicationContext(), LICENSE_METADATA_FILENAME, 0,
                        -1));
    }
    ...
    private static ArrayList<License> getLicenseListFromMetadata(String metadata) {
        ...
        for (String entry : entries) {
            ...
            licenses.add(
                    License.create(entry.substring(delimiter + 1), licenseOffset, licenseLength));
        }
