...
public final class CallLogEntryDescriptions {
     ...
     *   <li>The phone account description is of format "on {phone_account_label}, via {number}".
     *   For
     *       example:<br>
     ...
     * "2 calls, the latest is an answered call from Jane Smith, mobile, 11 minutes ago, on SIM
     * 1, via
     * 6502531234".
     */
