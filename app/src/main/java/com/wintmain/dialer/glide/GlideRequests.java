package com.wintmain.dialer.glide;
...
public class GlideRequests extends RequestManager {
    ...
    protected void setRequestOptions(@NonNull RequestOptions toSet) {
        if (toSet instanceof com.wintmain.dialer.glide.GlideOptions) {
            super.setRequestOptions(toSet);
        } else {
            super.setRequestOptions(new com.wintmain.dialer.glide.GlideOptions().apply(toSet));
        }
    }
}
