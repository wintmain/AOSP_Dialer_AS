...
public final class PhoneLookupInfo extends
    ...
    private com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info defaultCp2Info_;
    ...
    private com.wintmain.dialer.phonelookup.PhoneLookupInfo.MigratedInfo migratedInfo_;
    ...
    public static com.wintmain.dialer.phonelookup.PhoneLookupInfo parseFrom(byte[] data)
            throws com.google.protobuf.InvalidProtocolBufferException {
        return com.google.protobuf.GeneratedMessageLite.parseFrom(
                DEFAULT_INSTANCE, data);
    }
    ...
    public static Builder newBuilder(com.wintmain.dialer.phonelookup.PhoneLookupInfo prototype) {
        return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }

    public static com.wintmain.dialer.phonelookup.PhoneLookupInfo getDefaultInstance() {
    ...
    protected Object dynamicMethod(
        ...
        switch (method) {
            case NEW_MUTABLE_INSTANCE: {
                return new com.wintmain.dialer.phonelookup.PhoneLookupInfo();
            }
            case IS_INITIALIZED: {
                return DEFAULT_INSTANCE;
            }
            ...
            case GET_PARSER: {
                if (PARSER == null) {
                    synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.class) {
                        if (PARSER == null) {
    ...
    public static final class Cp2Info extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info parseFrom(byte[] data)
                throws com.google.protobuf.InvalidProtocolBufferException {
            return com.google.protobuf.GeneratedMessageLite.parseFrom(
                    DEFAULT_INSTANCE, data);
        }
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
        ...
        public static final class Cp2ContactInfo extends
            ...
            public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info.Cp2ContactInfo getDefaultInstance() {
                return DEFAULT_INSTANCE;
            }
            ...
            protected Object dynamicMethod(
                ...
                switch (method) {
                    case NEW_MUTABLE_INSTANCE: {
                        return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info.Cp2ContactInfo();
                    }
                    case IS_INITIALIZED: {
                        return DEFAULT_INSTANCE;
                    }
                    ...
                    case GET_PARSER: {
                        if (PARSER == null) {
                            synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.Cp2Info.Cp2ContactInfo.class) {
                                if (PARSER == null) {
                                    PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                                }
                            }
    ...
    public static final class SpamInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.SpamInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.SpamInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.SpamInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class PeopleApiInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.PeopleApiInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class SystemBlockedNumberInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.SystemBlockedNumberInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.SystemBlockedNumberInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.SystemBlockedNumberInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class CnapInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.CnapInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.CnapInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.CnapInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class CequintInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.CequintInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.CequintInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.CequintInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
    ...
    public static final class EmergencyInfo extends
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.EmergencyInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.EmergencyInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.EmergencyInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
...
// .MigratedInfo)
        ...
        public static com.wintmain.dialer.phonelookup.PhoneLookupInfo.MigratedInfo getDefaultInstance() {
            return DEFAULT_INSTANCE;
        }
        ...
        protected Object dynamicMethod(
            ...
            switch (method) {
                case NEW_MUTABLE_INSTANCE: {
                    return new com.wintmain.dialer.phonelookup.PhoneLookupInfo.MigratedInfo();
                }
                case IS_INITIALIZED: {
                    return DEFAULT_INSTANCE;
                }
                ...
                case GET_PARSER: {
                    if (PARSER == null) {
                        synchronized (com.wintmain.dialer.phonelookup.PhoneLookupInfo.MigratedInfo.class) {
                            if (PARSER == null) {
                                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
                            }
                        }
