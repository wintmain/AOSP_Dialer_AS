...
public class SimulatorSimCallManager {
    ...
    private static PhoneAccount buildSimCallManagerAccount(Context context) {
        return new PhoneAccount.Builder(getSimCallManagerHandle(context),
                "Simulator SIM call manager")
                .setCapabilities(
                        PhoneAccount.CAPABILITY_CONNECTION_MANAGER | PhoneAccount.CAPABILITY_RTT)
    ...
    public static PhoneAccountHandle getSimCallManagerHandle(@NonNull Context context) {
        return new PhoneAccountHandle(
                new ComponentName(context, SimulatorConnectionService.class),
                SIM_CALL_MANAGER_ACCOUNT_ID);
    }
