...
import com.wintmain.dialer.simulator.Simulator.ConferenceType;
import com.wintmain.dialer.simulator.Simulator.Event;
...
public class SimulatorConnectionsBankImpl
    ...
    public void updateConferenceableConnections() {
        ...
        for (String connectionTag : connectionTags) {
            SimulatorConnection connection = SimulatorSimCallManager.findConnectionByTag(
                    connectionTag);
    ...
    public void onEvent(@NonNull SimulatorConference conference, @NonNull Event event) {
        switch (event.type) {
            ...
            default:
                LogUtil.i(
                        "SimulatorConferenceCreator.onEvent",
                        "unexpected conference event: " + event.type);
                break;
        }
    }
}
