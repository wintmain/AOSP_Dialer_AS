...
public class SimulatorConnectionService extends ConnectionService {
    ...
    public Connection onCreateOutgoingConnection(
        ...
        if (!SimulatorComponent.get(this).getSimulator().isSimulatorMode()
            ...
            Toast.makeText(this, "Unregistering simulator, making a real phone call",
                            Toast.LENGTH_LONG)
                    .show();
        ...
        if (SimulatorSimCallManager.isSimulatorConnectionRequest(request)) {
            ...
            connection.setAddress(
                    ...
                    request
                            .getExtras()
                            .getInt(Simulator.PRESENTATION_CHOICE,
    ...
    public Connection onCreateIncomingConnection(
        ...
        if (!SimulatorSimCallManager.isSimulatorConnectionRequest(request)) {
            ...
            Toast.makeText(this, "Unregistering simulator, got a real incoming call",
                            Toast.LENGTH_LONG)
                    .show();
            SimulatorSimCallManager.unregister(this);
            return null;
    ...
    public void onConference(Connection connection1, Connection connection2) {
        ...
        for (Listener listener : listeners) {
            listener.onConference((SimulatorConnection) connection1,
                    (SimulatorConnection) connection2);
        }
    }
